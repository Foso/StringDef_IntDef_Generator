...
public class StringDefAction extends AnAction {
    ...
    public void actionPerformed(final AnActionEvent anActionEvent) {
        ...
        WriteCommandAction.runWriteCommandAction(requiredData1, () -> document.replaceString(pos, pos + 1, DefUtls.getDefString(clazzes, file, "String")));
    }
